...
from App.Casos.caso1.encabezados import encabezados
from App.compartidos.funciones_validadoras import cruzar_dataframes, construir_columna
from App.compartidos.Helpers.helpers import Portafolio_Core, Plantilla_Zonas_1
...
def case_one(path, file_name, sheet1, file_name2, sheet2):
    ...
    # cruzar_dataframes }} y crear columna [[Zona]]
    ...
    # creacion variables y las almaceno en diccionario para pascal como parametro de la funcion {{ cruzar_dataframes
    # }} y crear columna [[Ciudad]] para este caso varias de las variables son iguales a proceso anterior,
    # solo se reasigna valores de variables que cambian
