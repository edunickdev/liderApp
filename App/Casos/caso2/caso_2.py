...
from Casos.caso2.encabezados import encabezados
from compartidos.funciones_validadoras import llenar_vacios, redondear, reemplazo_caracteres, multi_fillna
...
def case_two(path, file_name, sheet1, file_name2, sheet2):
    ...
    df['Venta Neta'] = reemplazo_caracteres(df['Venta Neta'],",", "", decimas= 0,redondear= True)
    ...
    df['Telefono'] = reemplazo_caracteres(df['Telefono']," ", "", decimas= 0, redondear=False)
